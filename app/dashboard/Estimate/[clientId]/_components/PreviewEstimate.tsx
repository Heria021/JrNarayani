                    ...
                    <div className="flex justify-between items-start mb-3">
                        <div className="text-sm">
                            ...
                            <ul className="space-y-0 text-xs">
                                <li className="font-bold">{estimateInfo?.client.clientName}</li>
                                <li>+91 {estimateInfo?.client.clientNumber}</li>
                                {/* <li></li> */}
                                <ul className="space-y-0">
                                    <li>{estimateInfo?.client.clientAddress.home}</li>
                                    <li>{estimateInfo?.client.clientAddress.street}</li>
                                    <li>{estimateInfo?.client.clientAddress.city}</li>
                                </ul>
                            </ul>
                        </div>
                        ...
                        <div className="text-sm text-right">
                            ...
                            <ul className="space-y-0 text-xs">
                                <li><strong>Estimate No.:</strong> {estimateInfo?.estimate.estimateNumber}</li>
                                <li><strong>Date:</strong> {estimateInfo?.estimate.date}</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="p-6">
                    <Table>
                        <TableFooter className="border-b-2 border-t-2 bg-white border-[#ff6745] text-xs">
                            ...
                            <TableRow>
                                <TableCell colSpan={3} className="p-1"></TableCell>
                                <TableCell className="p-1 font-bold text-right">Tax ({estimateInfo?.estimate.gstPercentage}%):</TableCell>
